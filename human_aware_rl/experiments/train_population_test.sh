...
python ppo/ppo.py with EX_NAME="fcp_sp_random3" layout_name="random3" REW_SHAPING_HORIZON=2.5e6 LR=1e-3 PPO_RUN_TOT_TIMESTEPS=6e6 OTHER_AGENT_TYPE="sp" SEEDS="[3410]" VF_COEF=1 TIMESTAMP_DIR=False
