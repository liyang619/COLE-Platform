...
def get_algorithm_color(alg):
    ...
    elif alg in ["CP+BC_test", 'PPO_SP+BC_test_0', 'PPO_SP+BC_test_1', 'ppo_sp_no_advers_0', 'ppo_sp_no_advers_1',
                 'ppo_sp_base_0', 'ppo_sp_base_1']:
    ...
    elif alg in ["P+BC_test", 'PPO_BC_train+BC_test_0', 'PPO_BC_train+BC_test_1', 'ppo_bc_no_advers_0',
                 'ppo_bc_no_advers_1', 'ppo_bc_base_0', 'ppo_bc_base_1']:
