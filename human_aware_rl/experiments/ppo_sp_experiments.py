...
# from ppo.ppo import get_ppo_agent, plot_ppo_run, PPO_DATA_DIR
...
def run_all_ppo_sp_experiments(best_bc_model_paths):
    ...
    save_dict_to_file(ppo_sp_performance, PPO_DATA_DIR + "ppo_sp_models_performance")

if __name__ == "__main__":
    load = False
    if load:
        ppo_sp_performance = load_pickle(PPO_DATA_DIR + "ppo_sp_models_performance")
        save_dict_to_file(ppo_sp_performance, PPO_DATA_DIR + "ppo_sp_models_performance")
    else:
