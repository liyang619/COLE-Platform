...
PPO_DATA_DIR = '/nas/jichen/DATA_DIR/ppo_runs/'
...
def ppo_run(params):
    ...
    for seed in params["SEEDS"]:
        ...
        print(f"----- This seed took {(time.time() - seed_start_time)/60 :.1f} mins -----")
        
    print(f"----- All training took {(time.time() - start_time)/60 :.1f} mins -----")  
    return train_infos
