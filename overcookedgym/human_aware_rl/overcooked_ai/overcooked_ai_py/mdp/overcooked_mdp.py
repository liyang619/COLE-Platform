...
class OvercookedState(object):
    ...
    def from_dict(state_dict):
        ...
        object_list = [ObjectState.from_dict(getDictItemIfStr(o, state_dict["objects"])) for o in state_dict["objects"]]
        state_dict["objects"] = { ob.position : ob for ob in object_list }
        # jichen edit
        if 'order_list' in state_dict:
            state_dict['all_orders'] = state_dict['order_list']
            state_dict.pop('order_list')
